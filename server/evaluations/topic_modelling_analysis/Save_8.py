# Summary: Changed number of topics. Increased number of associated_word slightly but still a lot
# of "None" and still not a great variety of words. 
...
lda_model = LdaModel(corpus=corpus,
                     ...
                     passes=10,
                     random_state = 1)     # Number of passes through the corpus during training  
